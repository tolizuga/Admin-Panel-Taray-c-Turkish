...
system('cls');
system('title ADMIN PANEL TARACICI www.p4rs.net');
...
print "          \n +-++-++-++-++-++-++-++-+ 
                    |P||4||R||S||.||N||E||T|
                 +-++-++-++-++-++-++-++-+ +-++-++-++-+\n";
print "     |ADMIN||PANEL||TARACICI|\n";
print "                    TURKISH VERSION\n";
print "                           Coded By TOLIZUG4\n" ;
print "                     website:www.P4RS.NET\n\n";
print "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n" ;
print "\n";

print " Taramak istediginiz web sitesini girin \n";
print" Demo olarak: www.site.com veya www.site.com/path\n";
print" --> ";
$site=<STDIN>;
chomp $site;

print "\n\n";
print " Web sitesinin Dilini giriniz \n";
print" e.g.: asp, php, cfm, any\n";
print" Web Sitesinin Dilini Bilmiyorsaniz, yalnizca +++ veya +++ yazin\n";
print"--> ";
$code=<STDIN>;
chomp($code);
...
print "->Ýnternet sitesi: $site\n";
print "->|Web||Site||Kaynagi|: $code\n";
print "->|T||A||R||A||N||I||Y|O|R|...\n\n\n";
